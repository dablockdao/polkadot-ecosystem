...
## Wizard Amigos Community Videos
------------
<ShowcaseYouTube
  entries={[
       {
      href: 'https://www.youtube.com/watch?v=ZDBBos52JNM',
      title: 'Nina - WizardAmigos: Empowering Collaboration',
          },
                 {
      href: 'https://www.youtube.com/watch?v=BgeGZzmWVCw',
      title: 'Jam10o - Shokunin: How I Accidentally Created a DSL',
          },
                 {
      href: 'https://www.youtube.com/watch?v=4gHsvtHgYqA',
      title: 'Viktor - DarkSoil: Group organizing with DarkSoil and Holochain',
          },
                 {
      href: 'https://www.youtube.com/watch?v=ngWwAIi2Uxo',
      title: 'Olehmell - GrillChat: Decentralized chat built on IPFS, Subsocial blockchain and Next.js + Tailwind',
          },
  ]} />