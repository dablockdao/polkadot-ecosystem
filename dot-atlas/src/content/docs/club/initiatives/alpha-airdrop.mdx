...
sidebar:
    ...
    order: 2
hero:
  tagline: Engaging and educational Polkadot video content.
  image: 
    file: ../../../../assets/hub/initiatives/alpha-airdrop.png
  actions:
    - text: Youtube
      link: https://www.youtube.com/@alphaairdrop
      icon: external
    - text: X
      link: https://x.com/AlphAirdrop
      icon: external
      variant: secondary
---
