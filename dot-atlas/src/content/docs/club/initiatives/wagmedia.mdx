...
<ShowcaseYouTube
  entries={[
    ...
    {
      href: 'https://www.youtube.com/watch?v=zfznEfzjGPA',
      title: 'Learn How to Earn Real Crypto Tokens from Polkadot Ecosystem Projects by Creating Great Content!',
    },
        {
      href: 'How to Earn Crypto Rewards with WagMedia: A Polkadot Creators Beginner’s Guide',
      title: 'Learn how WagMedia works and start earning weekly DOT rewards for useful Polkadot content—step-by-step setup, quality checklist, and pro tips.',
    },
  ]}
/>