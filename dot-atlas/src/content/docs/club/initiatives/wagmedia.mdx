...
* **Payouts in DOT** to registered addresses (Polkadot SDK (formerly Substrate) / optional EVM), aligned with the program’s current funding and guidelines.
...
3. Use the WagMedia bot to **register your payout addresses** (Polkadot SDK is required for DOT payouts; you can also add an EVM address if requested).
