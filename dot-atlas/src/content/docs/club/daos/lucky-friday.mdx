...
They are also the creators of **[TeddyDAO](/club/daos/teddydao)**.
...
Notable among these is [**Teddy DAO**](/club/daos/teddydao/), a project that combines NFTs with social good, allowing participants to support charities through decentralized auctions.
