...
hero:
  tagline: Validator & Independent Media House.
  image: 
    file: ../../../../assets/hub/media/polkadotters.png
  actions:
    - text: Site
...
**Polkadotters is a participant in the 1000 Validators Program and a founder of the [DOT Validator Alliance DAO](/club/daos/dot-validator-alliance)**. They have also been active in assisting various projects to develop their collator programs. Their involvement extends to United Bloc DAO and the IBP program, underscoring their commitment to enhancing the Polkadot network’s decentralization and infrastructure.
...
<ShowcaseTwitter
  entries={[
    'https://x.com/Polkadotters1/status/1790653390441099372',
  ]}
/>
