...
## Amforc Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=z5QseqVcm6A',
      title: 'INFRASTRUCTURE BUILDERS PROGRAM (IBP) - Paris Dot Comm Day',
     },
      {
      href: 'https://www.youtube.com/watch?v=CEoy-HWWsv0',
      title: 'The Spammening',
    },
  ]}
/>