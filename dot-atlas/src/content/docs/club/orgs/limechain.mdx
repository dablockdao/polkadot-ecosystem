...
## LimeChain Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=r2sKfgOChI8',
      title: 'What kind of Dapps takes us to Web3 mass adoption?',
     },
               {
      ...
      title: 'AwesomeDOT Podcast #2 – Dive deep into Polkadot Testing Suite',
     },
                    {
      href: 'https://www.youtube.com/watch?v=l5zxIspLxIc',
      title: 'The next big thing in Web3?',
     },
  ]}
/>