...
Advisors include notable figures such as Jakub Gregus (Hydration Co-Founder), Lucas Vogelsang (Centrifuge Co-Founder), and Alexei Zamyatin (Interlay Co-Founder).
