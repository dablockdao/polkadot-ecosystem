...
## PureStake Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=G2ZM8_zReEI',
      title: 'Effective Log Management for Substrate-Based Nodes with PureStake CEO Derek Yoo',
     },
               {
      href: 'https://www.youtube.com/watch?v=uNKN7g-0DDI',
      title: 'Moonbeam, Moonriver & Building an Ecosystem | Derek Yoo of Purestake',
     },
               {
      href: 'https://www.youtube.com/watch?v=HPatTjjoF34',
      title: 'Moonbeam - A Smart Contract Parachain with Ethereum Compatibility',
     },
               {
      href: 'https://www.youtube.com/watch?v=lXw6GTNh73Y',
      title: 'The EVM Pallet and Purestake Moonbeam | Substrate Seminar | Archives',
     },
  ]}
/>