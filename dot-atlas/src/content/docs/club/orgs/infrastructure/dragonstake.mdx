...
## Dragonstake Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=6UDHZ35wY8Y',
      title: 'Talisman Wallet | Polkadot Wallet and Ethereum | Step by Step',
     },
               {
      href: 'https://www.youtube.com/watch?v=F24em9lD8Lg',
      title: '🔓 How to withdraw your POLKADOT ($DOT) in 3 minutes?',
     },
               {
      href: 'https://www.youtube.com/watch?v=AqpBTFF9J1w',
      title: 'How to use Kusama (KSM) Wallet | Step by Step 2023 (Polkadot Ecosystem)',
     },
               {
      href: 'https://www.youtube.com/watch?v=rL_vKdOHcBs',
      title: 'How to do STAKING of KUSAMA (KSM)? Step by Step | 2023',
     },
                    {
      href: 'https://www.youtube.com/watch?v=d1411bv1kEw',
      title: 'How to do STAKING in POLKADOT from 1 DOT | Step by Step Tutorial',
     },               {
      href: 'https://www.youtube.com/watch?v=u-0lpZTMl7c',
      title: 'How to use Polkadot JS Wallet | Complete Tutorial Step by Step 2023',
     },
  ]}
/>