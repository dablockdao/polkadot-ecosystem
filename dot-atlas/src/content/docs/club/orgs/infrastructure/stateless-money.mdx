...
## Stateless Money Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=0Q50TN1T5j8',
      title: 'How to delegate Polkadot (DOTs) & Kusuma (KSM)- Withdraw from exchange, set up wallet, and delegate',
     },
  ]}
/>