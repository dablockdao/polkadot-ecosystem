...
## Senseinode Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=a9Ed_Z1GA9o',
      title: 'The Staking Meetup BA - Extended',
     },
               {
      href: 'https://www.youtube.com/watch?v=chRAxrwKog4',
      title: 'Request a Node | SenseiNode Dashboard',
     },
               {
      href: 'https://www.youtube.com/watch?v=EQAmkVo6Qt0',
      title: 'SenseiTalks - Cami Russo: La dirección de cripto tiene que ser hacia el DeFi.',
     },
               {
      href: 'https://www.youtube.com/watch?v=185L6zEf7tY',
      title: 'Proof Of Stake | Sensei Dojo',
     },
  ]}
/>