...
## P2P Validator Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=JCawyp_OhMA',
      title: 'How To Stake Polkadot (DOT) with Polkadot.js | P2P Validator',
     },
               {
      href: 'https://www.youtube.com/watch?v=Kfv4wEHY144',
      title: 'How To Stake Polkadot (DOT) on Ledger Live | P2P Validator',
     },
                    {
      href: 'https://www.youtube.com/watch?v=Xd68J8yApVw',
      title: 'How To Stake Polkadot (DOT) using Polkadot.JS + Ledger | P2P Validator',
     },
  ]}
/>