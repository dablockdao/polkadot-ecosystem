...
## Zondax Community Videos
----------------
<ShowcaseYouTube
  entries={[
                         {
      href: 'https://www.youtube.com/watch?v=oOqF6Zt74Oo',
      title: 'Polkadot Migration App - Talisman Walkthrough',
     },
                            {
      href: 'https://www.youtube.com/watch?v=zEjlaRcRloM',
      title: 'Polkadot Generic App - development progress by Zondax',
     },
                                 {
      href: 'https://www.youtube.com/watch?v=wVMsWdwkfkA',
      title: 'sub0 Asia 2024 - Juan Leni (Zondax)',
     },
                                 {
      href: 'https://www.youtube.com/watch?v=6SyTAY2uSPY',
      title: 'Polkadot Decoded 2024 - POLKADOT LEDGER APP',
     },
  ]}
/>