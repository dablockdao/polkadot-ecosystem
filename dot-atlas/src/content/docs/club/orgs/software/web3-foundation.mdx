...
<ShowcaseText
  entries={[
    {
      href: 'https://futures.web3.foundation/',
    ...
    },
    {
      ...
      title: 'Education',
            ...
            {
      href: 'https://medium.com/web3foundation',
      title: 'Blog',
    },
  ]}
/>
...
## Web3 Foundation Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=pXksLYW4380',
      title: 'Edward Snowden at Web3 Summit 2019',
     },
               {
      href: 'https://www.youtube.com/watch?v=y8YyZELnVaw',
      title: 'Lecture 1: History of Blockchain Technology',
     },
                         {
      href: 'https://www.youtube.com/watch?v=MrWioikibEI',
      title: 'Web3 Citizenship - Gavin Wood - Web3 Summit 2024 Berlin',
     },
                    {
      href: 'https://www.youtube.com/watch?v=zJE3yfV35HM',
      title: 'Manifesto for a Dark Renaissance - Amir Taaki - Web3 Summit 2024',
     },
                    {
      href: 'https://www.youtube.com/watch?v=OPPMp7lorTQ',
      title: 'Lecture 2: Public-key Cryptography',
     },
                    {
      href: 'https://www.youtube.com/watch?v=bDIc3jcLlOE',
      title: 'Lecture 3: Introduction to Hashing',
     },
                         {
      href: 'https://www.youtube.com/watch?v=lfzOt3AEMAs',
      title: 'Interacting with Substrate Chains using JS and Python',
     },
                         {
      href: 'https://www.youtube.com/watch?v=fqNUaL9xX9g',
      title: 'Agents all the way down',
     },
                         {
      href: 'https://www.youtube.com/watch?v=C1teIFTSphE',
      title: 'WIP: Efficient Block-Auditing for Blockchains',
     },
  ]}
/>
