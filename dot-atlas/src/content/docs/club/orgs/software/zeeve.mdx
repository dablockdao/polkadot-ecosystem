...
## Launch Polkadot SDK Chains with Zeeve
For those looking to leverage the Polkadot SDK (formerly Substrate) framework, Zeeve provides a robust platform to build and deploy custom Polkadot SDK Chains. Key benefits include:
...
- **Interoperability**: Polkadot SDK chains can leverage features like XCMP for trusted interactions across networks, enhancing their functional scope.
- **Modular Architecture**: The modular framework of the Polkadot SDK allows developers to customize or replace components, supporting a wide range of blockchain applications.
...
## Zeeve Community Videos
----------------
<ShowcaseYouTube
  entries={[
                         {
      href: 'https://www.youtube.com/watch?v=ePMIsdo3iuI',
      title: 'Ghan Vashishtha and Zaid (Zeeve) - Sub0 2024',
     },
                            {
      href: 'https://www.youtube.com/watch?v=W4U_5dbIcOM',
      title: 'Ghan and Zaid Answer Audience Questions',
     },
          {
      href: 'https://www.youtube.com/watch?v=vuhtaHR5NO8',
      title: 'Introduction to Zeeve and Parachains',
     },
               {
      href: 'https://www.youtube.com/watch?v=W0lA3U3hIWE',
      title: 'Introduction to LARCH -The Zombienet Automation',
     },
                    {
      href: 'https://www.youtube.com/watch?v=770HTQRh2jk',
      title: 'Showcasing a running parachain',
     },
                    {
      href: 'https://www.youtube.com/watch?v=JQQC7CAtZAs',
      title: 'Parachain Analytics, Monitoring, and Alerts on Zeeve',
     },
                         {
      href: 'https://www.youtube.com/watch?v=YTM_kWbpz5Y',
      title: 'Zeeve Parachain Dashboard and DevNet Configuration',
     },
                         {
      href: 'https://www.youtube.com/watch?v=xwdQKWoF76g',
      title: 'Production Infrastructure Best Practices for Parachains',
     },
  ]}
/>