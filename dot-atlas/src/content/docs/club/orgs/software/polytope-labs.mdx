...
## Polytope Labs Community Videos
----------------
<ShowcaseYouTube
  entries={[
                           {
      href: 'https://www.youtube.com/watch?v=hZHgBEL6_ZM',
      title: 'Crypto-Economic Coprocessors & Their Applications - Seun Lanlege - Web3 Summit 2024 Berlin',
     },
          {
      href: 'https://www.youtube.com/watch?v=avd5P8qSvLY',
      title: 'Hyperbridge Gateway Funds Recovery Demo',
     },
               {
      href: 'https://www.youtube.com/watch?v=t6Ou6it68KU',
      title: 'Hyperbridge Gateway Demo (Powered by zk-proofs of consensus)',
     },
                    {
      href: 'https://www.youtube.com/watch?v=JmrDRas03sk',
      title: 'Hyperbridge AMA on Twitter Spaces',
     },
  ]}
/>