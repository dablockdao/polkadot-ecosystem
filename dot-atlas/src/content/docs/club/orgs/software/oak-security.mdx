...
- **Polkadot SDK and Ink!**: Providing security for Polkadot’s custom blockchain framework.
...
## Oak Security Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=grmzAU1Ae4Q',
      title: 'Blockchain Bridges, Hacks, and Security',
     },
               {
      href: 'https://www.youtube.com/watch?v=Z-uFw4qhFR0',
      title: 'What is an Audit?',
     },
                    {
      href: 'https://www.youtube.com/watch?v=w7M0e1hg0FE',
      title: 'The Sorry State of DeFi Security',
     },
                    {
      href: 'https://www.youtube.com/watch?v=uC_s2vtnsKk',
