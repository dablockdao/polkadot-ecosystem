...
## Scio Labs Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=Ccbzavn98dw',
      title: 'Encode x Polkadot Hackathon: Launch Event + Start building dApps on ink! workshop',
     },
  ]}
/>