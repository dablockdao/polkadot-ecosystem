---
title: Statescan
description: O StateScan é um explorador de blocos e plataforma de análise especificamente projetada para blockchains baseadas em Polkadot SDK.
sidebar:
    label: ✪ Statescan
    order: 2
hero:
  tagline: Explorador de blocos e plataforma de análise para blockchains baseadas em Polkadot SDK,
  image: 
