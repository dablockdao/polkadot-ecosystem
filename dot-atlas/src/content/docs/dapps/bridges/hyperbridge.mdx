  ...
  entries={[
    {
      ...
      description: ' tutorial about using Hyperbridge, a Polkadot-backed cross-chain protocol to allow users to transfer data and assets between standalone blockchains.',
            ...
            {
        href: 'https://www.youtube.com/watch?v=lgJWjGE71ac',
      title: 'Build a Hyperliquid Copy Trading Bot with Python',
      description: 'Learn how to automatically mirror professional traders positions on Hyperliquid using real-time gRPC streams and the Hyperliquid Python SDK. This tutorial walks through building a complete copy trading bot with automatic position sizing, slippage tolerance, and robust risk management.',
    },
            {
        href: 'https://www.youtube.com/watch?v=1vEt3HAyMf8',
      title: 'Build a Hyperliquid Liquidation Tracker with Python',
      description: 'Learn how to track real-time liquidations on Hyperliquid using gRPC streams and build a live dashboard with WebSockets. This tutorial walks through creating a complete liquidation monitoring system that streams data from the blockchain and displays it instantly in your browser.',
    },
  ]} />
