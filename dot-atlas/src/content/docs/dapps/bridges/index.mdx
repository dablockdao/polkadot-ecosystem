...
### Chainflip
A cross-chain DEX that swaps native assets between chains like BTC, ETH, and SOL without issuing wrapped tokens. It uses a Polkadot SDK (formerly Substrate) app-chain and a permissionless validator set with threshold signatures to manage protocol vaults and settle swaps.
...
* **GRANDPA bridge pallets** provide light clients for Polkadot SDK chains, enabling trust-minimized Polkadot SDK-to-Polkadot SDK links.
