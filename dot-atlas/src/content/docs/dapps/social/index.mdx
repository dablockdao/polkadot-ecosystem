  ...
  entries={[
    {
      ...
      title: 'Kilt Protocol',
                  ...
                  {
      thumbnail: import('/src/assets/dapps/social/heima.png'),
      ...
      title: 'Frequency',
              ...
              {
      thumbnail: import('/src/assets/dapps/social/entropretty.png'),
      href: '/dapps/social/entropretty/',
      title: 'Entropretty',
      },
  ]}
/>
...
| Virto and Kreivo    | Social commerce and walletless onboarding   | Polkadot SDK (formerly Substrate) chains      | Web component for app-funded transactions                        | Public demos and ecosystem pilots             | Retail and community transactions with minimal friction                |
