...
| **Heima**      | DID aggregation + VC issuance                                    | Privacy via **TEEs** + IdentityHub      | VC issuance & identity scores; off-chain aggregation | Polkadot SDK (formerly Substrate)/Polkadot; cross-chain reputation                                             | Reputation, airdrops, credit scoring, identity graphs                      |
