...
| **StaFi**             | **rDOT**  |                           Protocol-defined; rDOT redemption flows | Cross-chain via StaFi routes      | Varies                      | Multi-chain LSD; distinct risk model.              |
| **Lido (historical)** | **stDOT** |                                          Discontinued on Polkadot | N/A                               | N/A                         | No longer active for DOT.                          |
