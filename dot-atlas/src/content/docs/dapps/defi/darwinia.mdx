...
Darwinia Network is focused on **facilitating interoperability between diverse blockchains**. 
Darwinia provides the necessary tools and frameworks for decentralized applications (DApps) to **operate seamlessly across various blockchain networks**, thus addressing some of the most pressing challenges in the blockchain industry today.
...
## Darwinia Community Videos
------------
<ShowcaseYouTube
  entries={[
    {
      href: 'https://www.youtube.com/watch?v=Daghdhdwe4o',
      title: 'Token Transfer on Darwinia',
    },
        {
        href: 'https://www.youtube.com/watch?v=hFi9wEmlqHM',
      title: 'Smart Contract Deployment on Darwinia - ERC721',
    },
  ]} />