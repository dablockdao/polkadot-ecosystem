...
* Assuming ERC-20 contracts on non-EVM chains; Hydration and Bifrost assets are Polkadot SDK-native. Verify the correct asset ID before depositing.
...
No. MetaMask helps on Moonbeam, but Polkadot SDK-native dapps like Hydration and Bifrost work best with wallets that support both environments.
