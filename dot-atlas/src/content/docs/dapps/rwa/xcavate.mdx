...
sidebar:
    ...
    order: 2
hero:
  tagline: Real estate investment with blockchain technology.
  image: 
...
<ShowcaseYouTube
  entries={[
    ...
    href: 'https://www.youtube.com/watch?v=mmA3x5RpOGM',
      title: 'Xcavate - What we do',
    },
         {
    href: 'https://www.youtube.com/shorts/RtzuDzmzytE',
      title: 'Xcavate Revolutionizing Real Estate!',
    },
  ]} />
