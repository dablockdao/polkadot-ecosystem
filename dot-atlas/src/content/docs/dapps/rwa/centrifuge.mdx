...
Centrifuge originated on the Polkadot SDK. In 2025 it introduced an EVM-first, multichain architecture while maintaining compatibility with Polkadot’s direction (e.g., Asset Hub programmability).
