...
| **EWX**                    | Orchestrates **Worker Node Networks**             | DevOps, integrators            | Polkadot SDK (formerly Substrate)-based chain for WNN consensus    | Staking, coordination of worker votes/results          | Create/secure WNNs, finalize results        |
  ...
  entries={[
    ...
    href: 'https://www.youtube.com/shorts/zfizICAOp-o',
      title: 'Electric Growth Analysis! ⚡️Energy Web X on Polkadot',
                ...
                {
    href: 'https://www.youtube.com/watch?v=LKGil5uxK0I',
