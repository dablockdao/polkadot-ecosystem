...
In an era where digital communication and content creation are omnipresent, the importance of data sovereignty and user control over digital identities cannot be overstated.
Enter Subsocial, a cutting-edge platform designed to redefine social media through the power of blockchain technology. 
Built on the robust Substrate framework and integrated with the Polkadot network, Subsocial is not just a decentralized platform; it’s a gateway to creating censorship-resistant social networks and marketplaces that empower users like never before.
...
<ShowcaseYouTube
  entries={[
      ...
      description: 'How the Polkadot SDK Empowers Social Finance',
    },
            {
        href: 'https://www.youtube.com/watch?v=_Qy6XZYytvY',
      title: 'Explore Subsocial - The SocialFi Leader On Polkadot',
      description: 'Subsocial is creating an infrastructure to power the decentralized social media network.',
    },
                {
        href: 'https://www.youtube.com/watch?v=aSnUa57PQGk',
      title: 'Earning Passive Income With Subsocial',
      description: 'Earn passive income on Subsocial, the leading Polkadot parachain on the SocialFi narrative through staking the $SUB token and creating content on GrillApp.',
    },
                {
        href: 'https://www.youtube.com/watch?v=b2mkjLAtLYM',
      title: 'Will Web3 Social Networks Ever Be a Thing?',
      description: 'Fire up the grill to check out Subsocial new blockchain social app.',
    },
        {
