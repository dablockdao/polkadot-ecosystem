---
title: 'Dedot'
description: 'Descubre Dedot, un cliente JavaScript ligero que mejora el desarrollo de dapps para Polkadot y blockchains basadas en Polkadot SDK.'
hero:
...
**Dedot** es un cliente JavaScript de próxima generación diseñado específicamente para blockchains Polkadot y Polkadot SDK. Con su arquitectura ligera y tree-shakable y un conjunto de características avanzadas, Dedot promete redefinir la experiencia del desarrollador (DX) para la creación de aplicaciones descentralizadas (dapps) en un ecosistema multi-chain.
...
- **Soporte Limitado de Tipos y Sugerencias de API**: El soporte predeterminado para Polkadot y Kusama deja a los desarrolladores que trabajan con cadenas personalizadas basadas en Polkadot SDK luchando para definir tipos e identificar APIs apropiadas.
...
2. **Soporte Mejorado de Tipos y APIs**:
    - Dedot genera dinámicamente tipos y APIs de TypeScript a partir de metadata de runtime, proporcionando sugerencias precisas para blockchains basadas en Polkadot SDK y contratos inteligentes ink!.
