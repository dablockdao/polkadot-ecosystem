---
title: 'Zombienet'
description: 'Zombienet simplifica las pruebas para blockchains basadas en Polkadot SDK, habilitando la creación de redes efímeras, aserciones y compatibilidad multi-proveedor sin complicaciones.'
hero:
  tagline: 'Un framework de pruebas para redes de Polkadot SDK y Polkadot.'
  image: 
