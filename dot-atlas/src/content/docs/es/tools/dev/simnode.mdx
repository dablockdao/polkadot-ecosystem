---
title: 'Simnode'
description: 'Simnode ofrece a los desarrolladores de Polkadot SDK un control total sobre la producción de bloques, la verificación de firmas y la creación de entornos de prueba en tiempo real.'
hero:
  tagline: 'Herramienta de Desarrollo y Pruebas para Blockchains basadas en Polkadot SDK.'
  image: 
...
**Simnode** es un cliente shell alternativo para runtimes de Polkadot SDK, que brinda a los desarrolladores una flexibilidad y control excepcionales a la hora de probar y desarrollar blockchains. Gracias a sus potentes características, Simnode se adapta a las necesidades únicas de quienes requieren un control preciso sobre la producción de bloques, la verificación de firmas y las pruebas de runtime.  
- ***Simnode ofrece a los desarrolladores de Polkadot SDK un control total sobre la producción de bloques, la verificación de firmas y la creación de entornos de prueba en tiempo real.***
...
Diseñado para quienes construyen sistemas complejos basados en Polkadot SDK, Simnode sobresale en:
...
Simnode brinda ejemplos de integración para diferentes configuraciones de runtimes basados en Polkadot SDK, garantizando una amplia aplicabilidad en el ecosistema:
