...
1. **Ajustes en el Tipo Address:**  
   En Polkadot, el tipo `address` ocupa 32 bytes, a diferencia de los 20 bytes de Ethereum. Esto se alinea con la definición de “account” en Polkadot SDK. Los desarrolladores deben utilizar la sintaxis `address"5GBWmgdFAMqm8ZgAHGobqDqX6tjLxJhv53ygjNtaaAn3sjeZ"` para especificar literales de direcciones.
