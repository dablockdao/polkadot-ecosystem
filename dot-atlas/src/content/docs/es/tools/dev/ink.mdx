---
title: 'Ink!'
description: 'Ink! es un lenguaje de contratos inteligentes basado en Rust para Polkadot SDK, optimizando la seguridad, escalabilidad y eficiencia en el desarrollo blockchain.'
hero:
  tagline: 'Desarrollo de Contratos Inteligentes en Polkadot SDK y Polkadot.'
  image: 
...
<ShowcaseYouTube
  entries={[
      ...
      description: 'Exploración de características avanzadas de ink! y su integración con Polkadot SDK.'
          },
                       {
