...
## YoudleDAO Community Videos
------------
<ShowcaseYouTube
  entries={[
      {
      href: 'https://www.youtube.com/watch?v=aYAWW8ytKoM&',
      title: '#YoudleDAO: Youdle Management (Video Guide)',
          },
              {
      href: 'https://www.youtube.com/shorts/IFZ7ZGLNPnE',
      title: 'YoudleDAO - Dotcast',
          },
                {
      href: 'https://www.youtube.com/watch?v=2rIxhKcCoJ0',
      title: 'Youdles and the DAO owned NFT Collection - PNinja on the Road',
          },
              {
      href: 'https://www.youtube.com/watch?v=ZLA5MnxUpLQ&',
      title: 'What is YoudleDAO and tutorial on getting the Youdle Ticket',
          },
  ]} />