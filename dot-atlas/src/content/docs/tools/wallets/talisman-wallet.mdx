...
<ShowcaseYouTube
  entries={[
    ...
    },
    {
     ...
     {
      href: 'https://www.youtube.com/embed/MIJfshY60rk?si=Lv0H6JgnGAG_obZp',
      title: 'The Application Layer with Talisman',
      description: 'The Application Layer: Conquering Browser Based Substrate Development with Talisman.'
    },
         {
      href: 'https://www.youtube.com/embed/amCegXTK_xA?si=10itTZWyM1cM6sOd',
      title: 'Signet Multisigs',
      description: 'Data Privacy and Account Abstraction for Multisigs.'
    }
  ]} />
