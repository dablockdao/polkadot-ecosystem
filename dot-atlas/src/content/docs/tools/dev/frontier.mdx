---
title: Frontier
description: The Ethereum compatibility layer for the Polkadot SDK (formerly Substrate), enabling seamless dApp migration, EVM execution, and blockchain interoperability.
hero:
  tagline: The Ethereum Compatibility Layer for Polkadot SDK.
  image: 
...
**Frontier** serves as the essential Ethereum Virtual Machine (EVM) backbone for Polkadot, enabling seamless compatibility between Polkadot SDK (formerly Substrate)-based blockchains and Ethereum's ecosystem. Designed with developers in mind, Frontier allows Ethereum decentralized applications (dApps) to function unmodified within the Polkadot network, fostering interoperability and scalability.
...
For more technical insights and to explore its capabilities, consult the official [Frontier documentation](https://polkadot-evm.github.io/frontier/). Frontier represents a leap forward in blockchain technology, making it a cornerstone of the Polkadot ecosystem.
