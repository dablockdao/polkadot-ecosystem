...
# 2024 Recap: Laying the Foundation for Tanssi’s Mainnet Launch
2024 was transformative for Tanssi, preparing for the 2025 mainnet launch. Key milestones included:

## Key Achievements
- **Collaborations & Campaigns**: 
    - Partnered with Symbiotic to enable instant restaked network launches.
    - Ran "Let’s Forkin Dance," an incentivized testnet with 100k+ participants and 4M+ transactions.
- **Ecosystem Growth**: 
    - Registered 3,000+ testnet chains and surpassed 7.5M transactions on Dancebox.
    - Onboarded 100+ projects in DeFi, gaming, NFTs, RWAs, and AI.
- **Funding**: 
    - Raised $6M, totaling $9M in funding to drive innovation and growth.
- **Community Expansion**: 
    - Grew to 100k members across multiple languages, supported by dedicated ambassadors.

## 2024 Highlights
- **Grants Program**: Launched to support builders with funding, mentorship, and visibility.
- **Strategic Funding Rounds**: Secured $6M with backing from major investors like Gavin Wood and Rob Habermeier.
- **Global Events**: Featured at Devcon, Token2049, Blockchain Rio, Polkadot Decoded, and other major Web3 conferences.
- **Tanssi Cast Podcast**: Launched with episodes featuring Web3 leaders and discussions on market trends.
  ...
  entries={[
    {
      ...
      description: 'Access the original recap of 2024 for Tanssi Network.',
    },
  ]}
/>

## Looking Ahead to 2025
- **New Testnet Launch**: Integrating with Symbiotic for seamless network deployment.
- **Mainnet Launch**: Expected in early 2025, marking a pivotal milestone.
- **Community-Led Decentralization**: Empowering the Tanssi community to shape the network.

2024 was a breakout year, and 2025 is poised to be even bigger as Tanssi brings its vision to life. Stay tuned for more updates!
