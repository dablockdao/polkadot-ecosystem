...
- Building sovereign blockchains with Polkadot SDK (formerly Substrate).
- Creating application-specific runtimes using FRAME.
- Transforming Polkadot SDK-based chains into Polkadot-compatible parachains using Cumulus.
...
1. **Substrate (Polkadot SDK):** The foundational framework of the Polkadot SDK, now part of the Polkadot SDK itself. It simplifies blockchain development by providing pre-built modules and templates.
...
2. **FRAME:** FRAME (Framework for Runtime Aggregation of Modularized Entities) is the core framework used to develop application-specific blockchain runtimes on the Polkadot SDK. Key Aspects:
...
3. **Cumulus:** Cumulus bridges Substrate-based chains to the Polkadot network, converting them into fully functional parachains. Highlights:
    - **Parachain Compatibility:** Transforms existing Polkadot SDK chains into Polkadot-compatible parachains.
    - **Node Adaptation:** Converts Polkadot SDK-based nodes into parachain nodes.
  ...
  entries={[
    {
      ...
      description:
        ...
        {
      name: 'Polkadot SDK 2024 Recap',
      picture: 'https://avatars.githubusercontent.com/u/14176906?s=48&v=4',
      href: 'https://blog.kianenigma.com/posts/tech/polkadot-sdk-2024/',
      description:
        "Discover the remarkable achievements of the Polkadot SDK maintainers in 2024, along with other noteworthy ecosystem roundups.",
    },
  ]}
/>
