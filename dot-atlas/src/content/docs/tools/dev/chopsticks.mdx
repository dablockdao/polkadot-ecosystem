---
title: Chopsticks
description: Chopsticks simplifies Polkadot SDK (formerly Substrate) blockchain development with local forking, block replay, and XCM testing for efficient innovation.
hero:
  tagline: Create parallel reality of your Polkadot SDK network.
  image: 
...
Here’s a quick summary of how to get started with Chopsticks. For detailed instructions and additional information, refer to the **[official README file](https://github.com/AcalaNetwork/chopsticks) in the GitHub repository** provided by the authors.
</ShowcaseCTA>
...
## Conclusion
Chopsticks has emerged as an indispensable tool for developers working on Polkadot SDK-based blockchains. By facilitating local testing, debugging, and multi-chain interaction simulations, it empowers developers to innovate confidently in the Polkadot ecosystem.
