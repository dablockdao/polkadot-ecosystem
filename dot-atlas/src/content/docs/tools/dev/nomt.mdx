...
| Feature / DB         |                      **NOMT** |    **sp-trie (Polkadot SDK)** |   **JMT / sov-db (Sovereign)** |
| -------------------- | ----------------------------: | -------------------------: | -----------------------------: |
...
| Maturity             |          POC; evolving crates | Battle-tested in the Polkadot SDK |        Active in Sovereign SDK |
...
**How does NOMT differ from the Polkadot SDK’s sp-trie?**
