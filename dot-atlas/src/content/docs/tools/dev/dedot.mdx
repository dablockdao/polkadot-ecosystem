---
title: 'Dedot'
description: 'Discover Dedot, a lightweight JavaScript client enhancing dapp development for Polkadot and Polkadot SDK (formerly Substrate)-based blockchains.'
hero:
...
- **Limited Type and API Suggestions**: Default support for Polkadot and Kusama leaves developers working with custom Polkadot SDK-based chains struggling to define types and identify appropriate APIs.
...
2. **Enhanced Type and API Support**:
    - Dedot dynamically generates TypeScript types and APIs from runtime metadata, providing precise suggestions for Polkadot SDK (formerly Substrate)-based blockchains and ink! smart contracts.
