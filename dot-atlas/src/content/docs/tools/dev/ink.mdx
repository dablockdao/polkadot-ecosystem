---
title: Ink!
description: Ink! is a Rust-based smart contract language for the Polkadot SDK (formerly Substrate), optimizing security, scalability, and efficiency in blockchain development.
hero:
  tagline: Smart Contract Development on Polkadot SDK and Polkadot.
  image: 
