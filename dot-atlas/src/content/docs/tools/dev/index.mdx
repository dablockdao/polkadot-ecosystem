...
<ShowcaseImage
  entries={[
    ...
    {
      thumbnail: import('/src/assets/tools/dev/kitdot.png'),
      href: '/tools/dev/kitdot/',
      title: 'Kitdot CLI',
    },
  ]}
/>
