...
* A **governance platform** for Polkadot SDK (formerly Substrate) chains that **scans & normalizes on-chain governance data**, covering Polkadot, Kusama, and many parachains.
...
* **Cross-ecosystem coverage:** Polkadot, Kusama, and numerous parachains (e.g., Acala, Centrifuge, Hydration, Interlay, Phala).
