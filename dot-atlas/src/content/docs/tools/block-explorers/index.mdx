...
### Statescan
A **fully open-source** explorer purpose-built for Polkadot SDK chains. Clean interface with **pallet-specific views** (Identity, Multisig, Vesting, Proxy) and coverage across Polkadot/Kusama. Great for transparency and when you need pallet-level clarity.
