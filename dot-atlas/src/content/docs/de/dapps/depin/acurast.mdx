...
Acurast nutzt ein Polkadot SDK Runtime, das aus mehreren Polkadot SDK Pallets für das Acurast-Protokoll besteht. Das Netzwerk hat einen Kusama-Parachain-Slot für sein incentiviertes Testnetz gesichert und plant, an den Polkadot Agile Coretimeen teilzunehmen. Diese Integration bietet Zugang zur Sicherheit von Polkadot und Kusama und ermöglicht die Kommunikation mit anderen Parachains über das Cross-Consensus Message Format (XCM).
