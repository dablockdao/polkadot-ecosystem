...
<CardGrid>
  <Card title="Polkadot Wiki" icon="open-book">
    All the information about the Polkadot technical concepts.
    <LinkButton href="https://wiki.polkadot.network" variant="secondary" icon="external" iconPlacement="start">Polkadot Wiki</LinkButton>
  </Card>

  <Card title="Polkadot HandBook" icon="information">
    Handbook introduction to get involved in the Polkadot Ecosystem.
    <LinkButton href="/getting-started/" variant="secondary" icon="external" iconPlacement="start">Polkadot HandBook</LinkButton>
  </Card>
</CardGrid>
