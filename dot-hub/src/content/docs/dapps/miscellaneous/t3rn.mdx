...
hero:
  tagline: Execute smart contracts across multiple blockchains
  image: 
  ...
  entries={[
    {
      ...
      title: 'What Is t3rn? Exploring The Modular Interoperability Layer On Polkadot',
      description: 't3rn has been created to offer a fresh approach to the problem of blockchain interoperability – the ability for blockchains to communicate and interact with one another.',
    },
        {
        href: 'https://www.youtube.com/watch?v=KNkq1px-YNc',
      title: 'Using Polkadot to Enable Cross Chain Smart Contracts in any Language with T3rn',
      description: 'Csaint unravels the heavily backed, 2-time Web3 Grant recipient T3rn, who bringing cross chain, multi-language, single transaction smart contract calls to Polkadot.',
    },
  ]} />