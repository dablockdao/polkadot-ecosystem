...
hero:
  tagline: Exploring the Mind of Dr. Gavin Wood w/ Mark Cachia Podcast.
  image: 
    file: ../../../../assets/hub/initiatives/aglasswithgav.png
  actions:
    - text: Youtube
...
## A Glass with Gav Episodes
----------------
<ShowcaseYouTube
  entries={[
      {
      href: 'https://www.youtube.com/watch?v=5jrPlS2XaY8',
      title: 'The Tottori Matsui (episode 1)',
    },
        {
      href: 'https://www.youtube.com/watch?v=uU3A2BxBEI0',
      title: 'The Kavalan Podium - Part I (episode 2)',
    },
        {
      href: 'https://www.youtube.com/watch?v=9oa8a6ulLuA',
      title: 'The Kavalan Podium - Part II (episode 3)',
    },
        {
      href: 'https://www.youtube.com/watch?v=mEhj1_KQ1rU',
      title: 'The Kurayoshi Pure Malt (episode 4)',
    },
  ]}
/>
