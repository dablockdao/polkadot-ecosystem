...
## Protofire Community Videos
----------------
<ShowcaseYouTube
  entries={[
          {
      href: 'https://www.youtube.com/watch?v=Vc6E-KaMB7w',
      title: 'MULTISIG WALLET: CHALLENGES AND ADOPTION - Protofire - Paris Dot Comm',
     },
               {
      ...
      title: 'sub0 Asia 2024 - Gabriel Nicolas Gonzalez (Protofire)',
               ...
               {
      href: 'https://www.youtube.com/watch?v=QM9edAg8fF4',
      title: 'TOKEN WIZARD: A GATEWAY TO TOKENIZE EVERYTHING - Decoded 2024',
     },
  ]}
/>