...
The Polkadot Ledger app is designed to be versatile, offering compatibility with several leading wallets. Users can connect the app with [**Talisman**](https://dablock.com/dapps/talisman-wallet/), [**SubWallet**](https://dablock.com/dapps/subwallet/), [**Nova Wallet**](https://dablock.com/dapps/nova-wallet/), and soon, **Polkadot JS**. This wide range of integrations ensures that users can continue to use their preferred wallets while benefiting from the added security and convenience of the Ledger app.
